...
///
/// Orbitron + Rajdhani are bundled as assets (see pubspec `fonts:`) and used
/// directly via [TextStyle.fontFamily] — no runtime Google Fonts download, so
/// text renders correctly offline.
...
abstract class GameTypography {
  ...
  static TextStyle scoreDisplay({Color? color}) => TextStyle(
        fontFamily: headlineFont,
        fontSize: 36,
  ...
  static TextStyle scoreLarge({Color? color}) => TextStyle(
        fontFamily: headlineFont,
        fontSize: 48,
        fontWeight: FontWeight.w900,
        letterSpacing: 2,
  ...
  static TextStyle scoreSmall({Color? color}) => TextStyle(
        fontFamily: headlineFont,
        fontSize: 24,
        fontWeight: FontWeight.w700,
        letterSpacing: 0.5,
  ...
  static TextStyle gameTitle({Color? color}) => TextStyle(
        fontFamily: headlineFont,
        fontSize: 28,
  ...
  static TextStyle levelIndicator({Color? color}) => TextStyle(
        fontFamily: headlineFont,
        fontSize: 20,
        fontWeight: FontWeight.w700,
        color: color,
  ...
  static TextStyle statsValue({Color? color}) => TextStyle(
        fontFamily: bodyFont,
        fontSize: 18,
        fontWeight: FontWeight.w700,
        color: color,
  ...
  static TextStyle statsLabel({Color? color}) => TextStyle(
        fontFamily: bodyFont,
        fontSize: 12,
        fontWeight: FontWeight.w500,
        letterSpacing: 1,
